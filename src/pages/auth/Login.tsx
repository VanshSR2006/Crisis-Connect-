...
const RECENT_DISASTER_NEWS: NewsItem[] = [
  {
    ...
    summary:
      'Severe monsoon flooding continues to affect communities across Assam.',
    date: 'Aug 22, 2026',
    link:
      'https://www.aljazeera.com/news/2026/8/22/it-was-a-tsunami-floods-leave-death-trail-in-indias-assam',
  ...
  },
  {
    ...
    summary:
      'Rising Mandakini River levels have triggered renewed flood warnings in Chitrakoot.',
    date: 'Aug 2026',
    link:
      'https://www.ndtv.com/india-news/after-record-floods-fresh-alert-in-madhya-pradesh-town-as-river-rises-again-11981171',
  ...
  },
  {
    ...
    summary:
      'Rising Ganga water levels have increased flood concerns across low-lying areas.',
    date: 'Aug 2026',
    link:
      'https://timesofindia.indiatimes.com/city/varanasi/ganga-nears-warning-mark-flood-threat-looms-over-varuna-belt-in-varanasi/articleshow/133660622.cms',
  ...
  },
  {
    ...
    summary:
      'Flooding and landslide risks continue across several northeastern regions.',
    date: 'Aug 2026',
  ...
  },
  {
    ...
    summary:
      'Rescue teams continue operations following devastating Himalayan floods.',
    date: 'Aug 31, 2026',
    link:
      'https://www.reuters.com/world/asia-pacific/nepal-hydropower-sites-centre-flood-rescue-efforts-2026-08-31/',
...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (
        ...
        const authenticatedRole: UserRole =
        ...
        if (
          ...
          try {
            ...
            console.warn(
              'Speech synthesis on login error:',
              e
            );
          }
      ...
      if (apiError.status === 401) {
        ...
        setErrorMsg(
          'Crisis Connect server error. Please try again in a moment.'
        );
      } else {
        setErrorMsg(
  ...
  const scrollToLogin = () => {
    const el =
      document.getElementById('login-hero');
  ...
  return (
    <div className="w-full min-h-screen bg-white text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      <section
        id="login-hero"
        className="login-hero relative w-full bg-slate-950 px-4 pt-3 pb-10 sm:px-8 sm:pt-4 sm:pb-14 lg:px-10 lg:pt-5 lg:pb-16 overflow-hidden"
      >

        {/* Full-Bleed Rescue Background */}
        ...
        <div className="w-full max-w-4xl mx-auto flex items-center justify-between gap-2 sm:gap-4 relative z-10">
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-slate-900 border-2 border-blue-500 shadow-xl flex flex-col items-center justify-center p-3 text-center group-hover:scale-110 group-hover:border-blue-400 transition-all duration-300 relative">
              ...
              <p className="text-lg sm:text-2xl font-black text-white font-mono tracking-tight">
                04
              </p>

              <span className="text-[9px] sm:text-[10px] font-black uppercase text-blue-300 tracking-wider">
                Active Sectors
              </span>

            </div>

            <p className="text-[10px] sm:text-xs text-slate-700 font-bold mt-2 font-mono">
              UK, AS, OD, KL
            </p>
          ...
          <div className="flex-1 flex items-center justify-center gap-1.5 sm:gap-3 px-1 sm:px-3">
            ...
            {[200, 400, 600, 800].map(
              (delay) => (
                <span
                  key={delay}
                  className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-white border border-slate-300 shadow-xs shrink-0 animate-pulse"
                  style={{
            ...
            <span className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-white border-2 border-blue-400 shadow-sm shrink-0 animate-pulse" />
          ...
          <div className="flex-1 flex items-center justify-center gap-1.5 sm:gap-3 px-1 sm:px-3">
            ...
            <span className="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full bg-white border-2 border-amber-400 shadow-sm shrink-0 animate-pulse" />
          ...
          <div className="flex flex-col items-center text-center group">
            ...
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-slate-900 border-2 border-red-500 shadow-xl flex flex-col items-center justify-center p-3 text-center group-hover:scale-110 group-hover:border-red-400 transition-all duration-300 relative">
              ...
              <span className="text-[9px] sm:text-[10px] font-black uppercase text-red-300 tracking-wider">
                Field Response
              </span>
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          SECTION 2 — ACTIVE DISASTER ZONES
      ───────────────────────────────────────────────────────────────────── */}
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          SECTION 3 — RECENT DISASTER NEWS
      ───────────────────────────────────────────────────────────────────── */}
        ...
        <div className="w-full space-y-8">
          ...
          <div className="text-center space-y-3 max-w-2xl mx-auto px-4">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-xs font-bold uppercase tracking-wider">
              ...
              <span>
                Verified Disaster Intelligence
              </span>
            ...
            <p className="text-slate-600 text-sm sm:text-base font-medium">
              Latest emergency and flood updates from India and nearby regions.
              (Touch or hover card to pause)
            </p>
                ...
                >
                  ...
                  <div className="relative h-44 sm:h-48 w-full overflow-hidden bg-slate-900">
                    ...
                    <div className="absolute top-3 right-3">
                      ...
                      <span
                        className={`text-[10px] font-bold px-2.5 py-1 rounded-md uppercase tracking-wider border shadow-xs ${item.badgeColor}`}
                      >
                        {item.badge}
                      </span>
      ...
      <footer className="w-full bg-slate-950 text-slate-300 px-4 py-6 sm:px-8 lg:px-10 border-t border-slate-800 relative z-20">
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between text-xs text-slate-300 gap-2 sm:gap-0 font-semibold drop-shadow-xs">
          ...
          <div className="flex items-center gap-4 font-mono text-[11px] text-slate-400">
            ...
            <span>
              SIH 2026 DISASTER PLATFORM
            </span>

            <span>•</span>

            <span>
              RAPID RESPONSE PROTOCOL V1.0
            </span>
