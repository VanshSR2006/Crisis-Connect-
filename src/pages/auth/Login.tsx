...
export const Login: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      /*
       * IMPORTANT:
       * The backend may return optional user fields.
       * The frontend AuthUser type requires name to be a string.
       * So we normalize the backend response before calling setSession().
       */
      if (
        data?.access_token &&
        data?.user
        ...
        // Navigate strictly using the backend-verified role.
  ...
  const zoneOptions = [
    {
      label:
        'Uttarakhand Himalayan Sector (UK-01)',
      value: 'zone-north-01',
      risk: 'Critical',
      color:
    ...
    {
      label:
        'Assam Brahmaputra Flood Basin (AS-02)',
      value: 'zone-east-02',
      risk: 'High',
      color:
    ...
    {
      label:
        'Odisha & Bengal Coastal Belt (OD-03)',
      value: 'zone-south-03',
      risk: 'Medium',
      color:
    ...
    {
      label:
        'Kerala & Konkan Coastal Zone (KL-04)',
      value: 'zone-central-04',
      risk: 'Low',
      color:
          ...
          <div className="bg-white/90 border border-slate-200 rounded-2xl p-5 sm:p-6 space-y-4 shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              ...
              {zoneOptions.map((zone) => (
                <div
                  key={zone.value}
                  className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 cursor-default"
                >
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-slate-500 font-mono">
                      Sector ID: {zone.value}
                    </p>
                  </div>

                  <span
                    className={`px-2.5 py-0.5 rounded-md text-[10px] font-bold border font-mono uppercase shadow-xs ${zone.color}`}
                  >
                    {zone.risk}
                  </span>
                </div>
