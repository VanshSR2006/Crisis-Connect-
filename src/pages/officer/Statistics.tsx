...
export const Statistics: React.FC = () => {
  ...
  const resourceChartData = resources.map((r) => {
    ...
    const displayName = t(`resources.names.${r.name}`);
    return {
          ...
          <div className="space-y-3 text-[12px]">
            <div>
              <div className="flex justify-between mb-1 text-[#1b1b1d] font-medium">
                <span>{t('officer.statistics.floodWaterlogRescue')} ({incidents.filter((i) => i.category === 'flood' || i.category === 'rescue').length})</span>
            ...
            <div>
              <div className="flex justify-between mb-1 text-[#1b1b1d] font-medium">
                <span>{t('officer.statistics.medicalEmergency')} ({incidents.filter((i) => i.category === 'medical').length})</span>
                <strong className="font-mono">
            ...
            <div>
              <div className="flex justify-between mb-1 text-[#1b1b1d] font-medium">
                <span>{t('officer.statistics.fireElectrical')} ({incidents.filter((i) => i.category === 'fire').length})</span>
                <strong className="font-mono">
