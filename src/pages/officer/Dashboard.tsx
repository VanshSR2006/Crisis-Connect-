    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-[11px] font-semibold text-[#45464d]">
            ...
            {t(
              'officer.dashboard.liveFeedActive'
            )}
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-[#c6c6cd] rounded p-3 shadow-sm">
        <div className="flex items-center justify-between mb-3">
          ...
          >
            <option value="z-silchar">
              Silchar
            </option>

            <option value="z-lakhipur">
              Lakhipur
            </option>

            <option value="z-katigorah">
              Katigorah
            </option>
          </select>
        </div>
