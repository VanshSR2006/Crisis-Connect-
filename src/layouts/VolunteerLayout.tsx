...
export const VolunteerLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#e2e8f0] text-[#1b1b1d] font-sans">
      {/* ── Dark Navy 3D Left Sidebar for Desktop/Tablet ─────────────────────────── */}
      <aside className="hidden md:flex md:w-56 flex-col bg-gradient-to-b from-[#0f172a] via-[#0b1120] to-[#070a14] text-white border-r-2 border-slate-800 shrink-0 min-h-screen sticky top-0 h-screen overflow-y-auto shadow-[10px_0_35px_rgba(0,0,0,0.35)] z-50">
        ...
        <div className="h-14 px-4 flex items-center border-b border-slate-800 shrink-0 gap-2.5 bg-slate-950/40 shadow-xs">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[9px] font-extrabold text-emerald-400 uppercase tracking-widest drop-shadow-xs">
              {t('common.volunteerField')} Portal
            </span>
          </div>
        </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    isActive
                      ? 'bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 text-white shadow-[0_6px_16px_rgba(16,185,129,0.4),inset_0_1px_0_rgba(255,255,255,0.3)] border-t border-emerald-400/40 border-b border-emerald-800 -translate-y-0.5'
        ...
        <div className="p-3 border-t border-slate-800 bg-slate-950/60">
          <div className="flex items-center gap-2 text-[11px] text-emerald-300 font-bold bg-slate-900 shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] rounded-xl px-3 py-2 border border-slate-800">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 inline-block animate-pulse shadow-md shadow-emerald-400/60" />
            <span className="truncate">{t('common.fieldRadioActive')}</span>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#e2e8f0]">
        ...
        <header className="sticky top-0 z-40 bg-gradient-to-b from-[#0f172a] via-[#0f172a] to-[#090d16] border-b-2 border-slate-800 shadow-[0_8px_20px_rgba(0,0,0,0.3)]">
          <div className="w-full px-6 h-13 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5 md:hidden">
              <div className="w-7 h-7 bg-gradient-to-br from-emerald-500 to-teal-700 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md border border-emerald-400/30">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-[10px] font-semibold bg-emerald-900/80 text-emerald-200 px-1.5 py-0.5 rounded uppercase tracking-wider border border-emerald-500/30">
            ...
            <div className="hidden md:flex items-center gap-2 text-slate-300 text-xs font-black uppercase tracking-wider drop-shadow-xs">
              ...
              <span>VOLUNTEER EMERGENCY FIELD COMMAND</span>
            </div>

            {/* Status + Language Toggle + Switch */}
            <div className="flex items-center gap-3.5 ml-auto">
              <LanguageToggle variant="light" />
              <div className="hidden sm:flex items-center gap-2 bg-slate-900/80 px-2.5 py-1 rounded-full border border-slate-700/60 shadow-[inset_0_1px_3px_rgba(0,0,0,0.4)] text-[11px] font-extrabold text-emerald-300">
                <span className="w-2 h-2 rounded-full bg-emerald-400 inline-block shadow-xs shadow-emerald-400/60" />
        ...
        <nav
          className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-300 shadow-[0_-4px_15px_rgba(0,0,0,0.1)]"
                    ...
                    <>
                      <div
                        className={cn(
                          ...
                          isActive && 'bg-emerald-100 shadow-xs'
                        )}
                      >
                        <Icon className={cn('h-5 w-5', isActive && 'text-emerald-800')} />
                      </div>
                      <span
                        className={cn(
